...
public class AllPurchasesModel implements Serializable{
	...
	public AllPurchasesModel(int purchaseId, String dateTime, int quantity, double totalAmount, String userName,
