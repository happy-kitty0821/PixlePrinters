...
/**
	...
	public class Utilities {
		...
		public static final String Add_Brands = "INSERT INTO Brand (CompanyName, country, contactInformation, website) VALUES(?,?,?,?) ";
		...
		public static final String Profile_Picture_Store_Dir = "/home/happy-kitty/eclipse-workspace/PixlePrint/src/main/webapp/Uploads/ProfilePicture/";
		//product image store path
		public static final String Product_Picture_Store_Dir = "/home/happy-kitty/eclipse-workspace/PixlePrint/src/main/webapp/Uploads/ProductImages/";
